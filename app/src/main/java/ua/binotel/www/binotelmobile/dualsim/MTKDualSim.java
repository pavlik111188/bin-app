package ua.binotel.www.binotelmobile.dualsim;
...
import ua.binotel.www.binotelmobile.BuildConfig;


/**
 * <pre>
 * @copyright  : Copyright ©2004-2018 all rights reserved　XXXXXXXXXXXXXXXXXXXXXX
 ...
 * @version    : 1.0
 * @desc       : MediaTek chip system dual card category
 * </pre>
 */
...
public class MTKDualSim extends DualsimBase {
    ...
    //Android system API which provided TelephonyManager
//    private TelephonyManager mySystemAPITM;

    //MTK Chip system TelephonyManagerEx Single case
    private Object myMTKTMInstance;

    //4.0+ com.mediatek.telephony.smsManagerEx Single case
    private  Object mySmsManagerExInstance;

    //4.0- android.telephony.gemini.GeminiSmsManager Static method class
    ...
    public boolean sendDataMessage(String destinationAddress, String scAddress, short destinationPort,
        ...
        // When testing need to pay special attention to the order of the parameters correspond
        try {
